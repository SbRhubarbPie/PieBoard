...
# June 1, 2025
  Redid the pcb power routing and changed some components so I can only order off of one website. PCB is ready for order. Continued to work on the case, I think it is almost done.
